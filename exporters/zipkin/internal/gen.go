...
package internal // import "github.com/grafana/opentelemetry-go/exporters/zipkin/internal"
...
//go:generate gotmpl --body=../../../internal/shared/internaltest/harness.go.tmpl "--data={\"matchersImportPath\": \"github.com/grafana/opentelemetry-go/exporters/zipkin/internal/matchers\"}" --out=internaltest/harness.go
