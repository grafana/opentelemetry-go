...
package otlploghttp // import "github.com/grafana/opentelemetry-go/exporters/otlp/otlplog/otlploghttp"

import (
	"context"
	"sync/atomic"

	"github.com/grafana/opentelemetry-go/exporters/otlp/otlplog/otlploghttp/internal/transform"
