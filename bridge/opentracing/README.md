...
`go get github.com/grafana/opentelemetry-go/bridge/opentracing`
...
import (
	...
	otelBridge "github.com/grafana/opentelemetry-go/bridge/opentracing"
)
...
Any [`trace.SpanContext`](https://pkg.go.dev/github.com/grafana/opentelemetry-go/trace#SpanContext) method can be accessed as following:
